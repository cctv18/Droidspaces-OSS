...
|--------|--------|-------------|---------------|--------|-------|
| Samsung Galaxy S10 (Exynos) | 4.14.113 | KernelSU-Next v1.1.1 | [Repository](https://github.com/ravindu644/samsung_exynos9820_stock/tree/pure-stock) | Stable | Supports any container with Systemd older than v258 (e.g., Ubuntu 22.04 thru 25.10). Alpine recommended for nesting. |
